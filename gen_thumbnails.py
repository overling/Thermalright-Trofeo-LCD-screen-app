...
# Sample sensor values for rendering
SAMPLE_SENSORS = {
    'cpu:temp': 45.0,
    'cpu:usage': 35.0,
    'cpu:freq': 4200.0,
...
def render_theme(theme_path):
    """Render a theme to a 1920x400 image and save as Theme.png"""
            ...
            if etype == 'text':
                ...
                if value is not None:
                    ...
                    try:
                        ...
                        text = str(value)
                    if el.get('show_unit', True):
                        pass  # unit already in format
                    draw.text((x, y), text, fill=rgb, font=font)
